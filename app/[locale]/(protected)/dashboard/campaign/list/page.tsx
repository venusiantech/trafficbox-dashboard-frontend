          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <h3
                  className="text-lg capitalize font-semibold text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors truncate"
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {isPaused && !isArchivedState && (
                <Button
                  size="sm"
                  className="bg-default text-white h-7 text-xs px-3"
              ...
              <Button
                ...
                size="sm"
                onClick={() => handleViewCampaign(campaign.id)}
                className="h-7 text-xs px-3 font-medium border-default dark:border-gray-600 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-100"
              >
                Settings
              </Button>
            </div>
  ...
  return (
    <div className="space-y-4 px-2">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        <TabsList className="bg-transparent border-gray-200 dark:border-gray-700 p-0 h-auto gap-0 rounded-none">
          <TabsTrigger
            value="active"
            className="bg-transparent border-b-2 border-transparent data-[state=active]:border-purple-600 data-[state=active]:bg-transparent data-[state=active]:text-gray-900 dark:data-[state=active]:text-gray-100 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-none px-0 py-3 mr-6 font-medium text-sm shadow-none"
          >
