    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div className="flex items-center">
              <h3 className="text-lg font-medium">Referrers</h3>
        ...
        <Card className="p-6">
          <div className="space-y-6">
            <div className="flex items-center">
              <h3 className="text-lg font-medium">Traffic Settings</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <InfoTooltip content="Comma-separated language codes (e.g., en,fr,es)" />
                </div>
                <Input
                  id="languages"
                  name="languages"
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <InfoTooltip content="Target country for your traffic" />
                </div>
                <Select
                  value={formData.geo}
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div className="flex items-center">
              <h3 className="text-lg font-medium">Campaign Renewal</h3>
